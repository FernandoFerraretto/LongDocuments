...
#define o paths
#f_main = 'dataset_msmarco/V04/msmarco_longnoise250.csv'
f_main = '../../dataset_msmarco/V04/msmarco_nonoise.csv'


#carrega dos arquivos csv
if demo ==0:
    #set_train = load_dataset('csv', delimiter = ',', data_files=f_main, split='train[:100000]')
    #set_eval = load_dataset('csv', delimiter = ',', data_files=f_main, split='train[100000:105000]')
...
model = RobertaForSequenceClassification.from_pretrained('google/bigbird-roberta-base')
